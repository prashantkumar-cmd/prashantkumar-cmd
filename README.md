...
scalability and deployment velocity.– Designed and delivered Spring Boot microservices for high-traffic logistics applications: Billing, Warehouse Management, Freight
lanes, Delivery, and Capacity Planning.– Owned full SDLC– API design, implementation, and CI/CD deployment (Jenkins/Azure DevOps)– with independent
